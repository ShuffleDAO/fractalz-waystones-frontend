...
export default function Navigation(props: any){
    ...
    return (
        <nav className={"flex flex-wrap flex-col md:flex-row md:justify-between justify-center md:px-10 pt-5"}>
            ...
            <button disabled={busy} onClick={toggleAudioState} className={"self-center p-3 text-lg grow-0"}>
